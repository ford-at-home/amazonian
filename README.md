...
<p align="center">
  <img src="docs/amazonian-skills-whiteboard.png" alt="Whiteboard-style infographic mapping the 13 Amazonian skills onto the product lifecycle (Discover, Define, Design, Build [out of scope], Launch, Operate, Learn). Constructive skills are shown as rectangles, interrogative skills as hexagons. Skill 08 carries a Lean Startup tag, skill 09 a Pre-mortem tag, and skills 11 and 13 carry Google-OKR tags, reflecting the suite's mixed-origin influences. A side rail shows the two cross-cutting passes (amazon-writing-linter and leadership-principles-reviewer). Six yellow sticky notes along the bottom name the failure modes the interrogative skills exist to catch: founder bias laundering, PRFAQ drift, metric satisficing, sandbagging laundering, stale dissent reuse, and portfolio drift. A bottom-corner Influences panel keys the four non-Amazon traditions (Lean Startup, Pre-mortem, Google OKR) plus the suite-original named-failure-mode pattern." width="900" />
</p>
